...
wind = Tk()
wind.title("Calculator Sederhana.gts")
wind["bg"] = "#d1d1d1"
wind.geometry("300x400")

text = Entry(wind, font=("arial", 15))
...
btnpoint = Button(frame4, text=".", width=9, height=3,
                  command=lambda: addToText("."))
btnpoint.pack(side=LEFT)
btnzero = Button(frame4, text="0", width=9, height=3,
                 command=lambda: addToText("0"))
btnzero.pack(side=LEFT)
btneq = Button(frame4, text="=", width=9, height=3,
...
btnmul = Button(rightFrame, text="x", width=9, height=3,
                command=lambda: addToText("*"))
btnmul.pack()
btndif = Button(rightFrame, text="-", width=9, height=3,
                command=lambda: addToText("-"))
btndif.pack()
